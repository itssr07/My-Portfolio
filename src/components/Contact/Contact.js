    ...
    <div class="-mx-4 flex flex-wrap lg:justify-between">
      <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
        <div class="mb-12 max-w-[570px] lg:mb-0">
          <span class="text-gray-400 mb-4 block text-base font-semibold">
            Contact Us
          </span>
          <h2
            class="text-purple-900 mb-6 text-[32px] font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px]"
          >
            GET IN TOUCH WITH US
          </h2>
          <p class="text-gray-400 mb-9 text-base leading-relaxed">
          ...
          <div class="mb-8 flex w-full max-w-[370px]">
            <div
              class="bg-gray-300 text-purple-900 mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]"
            >
              <svg
                width="24"
                height="24"
            ...
            <div class="w-full">
              <h4 class="text-gray-400 mb-1 text-xl font-bold">Address</h4>
          ...
          <div class="mb-8 flex w-full max-w-[370px]">
            <div
              class="bg-white text-purple-900 mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]"
            >
              <svg
                width="24"
                height="26"
            ...
            <div class="w-full">
              <h4 class="text-gray-400 mb-1 text-xl font-bold">Phone Number</h4>
              <p class="text-gray-400 text-base">(+91) 8789599125</p>
            </div>
          </div>
          <div class="mb-8 flex w-full max-w-[370px]">
            <div
            ...
            <div class="w-full">
              <h4 class="text-gray-400 mb-1 text-xl font-bold">Email Address</h4>
              <p class="text-gray-400 text-base">ranjanshitanshu10@gmail.com</p>
            </div>
          </div>
        </div>
      </div>
