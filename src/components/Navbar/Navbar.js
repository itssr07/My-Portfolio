      ...
      <body class="bg-blue-500">
        <nav class="relative px-4 py-4 flex justify-between items-center bg-white">
          <a class="text-3xl font-bold leading-none" href="#">
            <img src="/a (2).png" className='h-8 w-36 animate-bounce'/>
          </a>
          <div class="lg:hidden">
          ...
          <ul class="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
            ...
            <Link class="hover:text-gray-200" to="/">
              <a class="text-base text-gray-900 font-semibold hover:text-gray-500" href="#">
                Home
              </a>
              </Link>
            </li>
            ...
            <Link class="hover:text-gray-200" to="/about">
              <a class="text-base text-gray-900 font-semibold" href="#">
                About Us
              </a>
              </Link>
            </li>
            ...
            <li>
            <Link class="hover:text-gray-200" to="/skill">
              <a class="text-base text-gray-900 font-semibold hover:text-gray-500" href="#">
                Skills
              </a>
              </Link>
            ...
            <Link class="hover:text-gray-200" to="/Portfolio">
              <a class="text-base text-gray-900 font-semibold hover:text-gray-500" href="#">
                Projects
              </a>
              </Link>
          ...
          <a href={Resume} download
            class="hidden lg:inline-block py-2 px-6 bg-purple-900 hover:bg-blue-600 text-sm text-white font-bold rounded-xl transition duration-200"
          ...
          <nav class="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
            ...
            <div>
              <ul>
                <li class="mb-1">
                  <a
                    class="block p-4 text-sm font-semibold text-black hover:bg-blue-50 hover:text-blue-600 rounded"
                    href="#"
                  >
                    Home
                  </a>
